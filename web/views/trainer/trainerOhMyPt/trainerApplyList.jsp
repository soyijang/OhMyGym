      ...
      <div class="matching_box">
         ...
         <div class="matching_content">
            ...
            <div id="rejectArea">
                  ...
                  <input onclick="submitReject()" id="rejectBtn" value="매칭거절 확정" style="text-align: center;">
            </div>
         </div>
      </div>
   </div>
   ...
   <script>
      ...
      function goMatchChat(){
         ...
         function submitReject() {
             ...
             var followerId = $("#applyid").text();
             var rejectReason = $("#rejectComment").val();
             ...
             $.ajax({
             	...
             	success: function(data) {
             		console.log("됐다");
             		alert("매칭 거절이 완료되었습니다.");
             		location.href = "<%= request.getContextPath() %>/selectApplyList.pt";
             	},
             	error: function(data) {
             		console.log("실패");
             	}
