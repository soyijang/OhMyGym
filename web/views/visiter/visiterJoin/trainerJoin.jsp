                ...
                <div id="main-center">
                    ...
                    <div class="join2">
                        ...
                        <div>
                            ...
                            <a href="followerJoin2.html" id="fnt" class="fnt1">팔로워</a>
                            <a href="" id="fnt" class="fnt2">트레이너</a>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="password" name="password1" id="password1"
                                                    style="height: 40px" class="MS_input_txt w137" value="" size="50"
                                                    maxlength="20" onkeyup="check_pwd_length(this, 'password');"
                                                    placeholder="비밀번호를 입력해주세요"> <span class="idpw-info"><br>
                                                    <p style="font-size: 0.7em; color: orangered;">* 비밀번호는 8자 이상으로 입력해
                                                        주세요.</p>
                                                </span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="select"><select name="birthyear"
                                                    style="width:100px; height: 40px;" class="MS_select MS_birthday">
                                            ...
                                            <td>
                                                <div class="tb-l post">
                                                    ...
                                                    <input type="text" name="hpost" form="join_form" id="hpost"
                                                        style="width:100px; height: 40px;" class="MS_input_txt" value=""
                                                        size="7" maxlength="15" readonly="">
                                        ...
                                        <tr>
                                            <th>집주소</th>
                                            <td><input type="text" name="haddress1" form="join_form" id="haddress1"
                                                    style="width:360px; height: 40px;" class="MS_input_txt w415"
                                                    value="" size="50" maxlength="100" readonly="readonly"></td>
                                        </tr>
                                        <tr>
                                            <th>상세주소 </th>
                                            <td><input type="text" name="haddress2" form="join_form" id="haddress2"
                                                    style="width:360px; height: 40px;" class="MS_input_txt w415"
                                            ...
                                            <td class="select">
                                                ...
                                                <span id="direct_email" style="margin-top:3px;display:inline-block">
                                                    <input type="text" name="email3" id="email3"
                                                        style="width:200px; height: 40px;" class="MS_input_txt" value=""
                                                        size="15" maxlength="25"
                                                        onchange="this.form.emailcheck.value=''">
                                                </span>
                                                <select name="email2" id="email2" class="MS_select MS_email"
                                                    style="width:100px; height: 40px;" style="margin-right:5px;"
                                                    onchange="viewdirect()">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="hidden" name="etcphone" form="join_form" value="">
                                                <select name="etcphone1" id="etcphone1" form="join_form"
                                                    style="width:100px; height: 40px;" class="MS_select MS_tel">
                                                    <option value="">선택</option>
                                        ...
                                        <tr>
                                            <th>은행</th>
                                            <td><input type="hidden" name="bank" form="join_form" value="">
                                                <select name="bank" id="bank" form="join_form"
                                                    style="width:100px; height: 40px;" class="MS_bank">
                                                    <option value="">선택</option>
                                                ...
                                                <input type="text" name="bank_no" form="join_form" id="bank_no"
                                                    style="width:255px; height: 40px;" class="MS_bank" value=""
                                                    size="30" maxlength="100" placeholder="계좌번호입력 ('-'제외)">
