 ...
 */
@WebServlet("/groupUpdate.bm")
public class UpdateGroupBookMarkServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateGroupBookMarkServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = new BookMarkService().deleteGroupBookMark(userId, boardNum);
