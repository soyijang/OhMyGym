...
<body>
    ...
    <section>
        ...
        <!--정렬 설정 영역-->
        	...
        	<button style="background: orangered; color: white; position: absolute; left: 900px; top: 100px;">챌린지 등록</button>
        <article id="alignmentArea">
            <select name="alignment" id="alignment">
                <option value="trainingDate">진행중</option>
                <option value="matchingNumDesc">담당자 순</option>
            ...
            <div align="center">
                <table>
                    <tr>
                        ...
                        <th width="50px">챌린지명</th>
                        <th width="70px;">담당자</th>
                        <th width="80px;">진행일</th>
                    </tr>
                    <tbody>
                    <tr>
                        <td>1</td>
                        <td style="color: orangered; font-weight: bold;">진행중</td>
                        <td>물마시기 챌린지</td>
                        <td>챌린지담당자</td>
                        <td>2020-06-28 ~ 2020-07-07</td>
                    </tr>
                    <tr>
                        <td>2</td>
                        <td style="color: orangered; font-weight: bold;">진행중</td>
                    ...
                    <tr>
                        <td>4</td>
                        <td style="font-weight: bold;">종료</td>
                        <td>물마시기 챌린지</td>
                        <td>챌린지담당자</td>
                        <td>2020-06-28 ~ 2020-07-07</td>
                    </tr>
