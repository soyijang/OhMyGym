...
/**
 * Servlet implementation class SelectTrainerPrizeServlet
 */
@WebServlet("/select.prize.ti")
public class SelectTrainerPrizeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectTrainerPrizeServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String page = "";
		if(!hmap.isEmpty()) {
			page = "views/trainer/trainerMypage/trainerMyPrize.jsp";
