...
<body>
	...
	<div class="left-container">
		<div class="class_category_container">
			...
			<ul class="class_category_list" style="height: 680px;">
	...
	<div>
		<div class="left-container"
			style="height: 650px; width: 550px; margin: 30px; text-align: center;">
			...
			<div>
				...
				<p style="font-size: 18px;">
					<input id="comment" type="text" placeholder="코멘트를 입력해주세요">
				</p><br>
