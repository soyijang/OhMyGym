...
/**
 * Servlet implementation class selectTrainerInfoServlet
 */
@WebServlet("/select.ti")
public class SelectTrainerEduServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectTrainerEduServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String page = "";
		if(!hmap.isEmpty()) {
			page = "views/trainer/trainerMypage/trainerMyEducation.jsp";
