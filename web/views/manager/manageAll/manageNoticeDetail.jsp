...
<body>
	...
	<tr>
		...
		<textarea style="resize: none; width: 800px; height: 50px;" readonly="readonly"><%=notice.getBoardTitle()%></textarea></td>
		</legend>
	</tr>
	<tr>
		...
		<textarea style="resize: none; width: 800px; height: 350px;" readonly="readonly"><%=notice.getBoardContent()%>
