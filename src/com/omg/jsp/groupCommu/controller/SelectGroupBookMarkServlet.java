 ...
 */
@WebServlet("/checkBookMark.follower")
public class SelectGroupBookMarkServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectGroupBookMarkServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int resultNumber = new GroupCommuService().selectBookMark(postId);
