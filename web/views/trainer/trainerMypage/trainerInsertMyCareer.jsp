				...
				<div class="info-container">
					...
					<form name="form1" id="form1" method="post">
						<div class="tbl_normal diagnosis_step3 mb5" id="aboutCareer">
							...
							<% 
							int num = 0;
							for(TrainerCareer b : careerList) { %>
							...
							<table class="" style="margin-top: 20px;">
								<tbody>
									<tr>
										...
										<td><input type="text" name="compNm" id="compNm_1" style="width: 200px" value="<%= b.getCompName()%>">
									</tr>
									...
									<tr>
										<th scope="row"><span id="titleworkStartDt_1">근무시작 </span></th>
										<td><span class="calendar" id="spanworkStartDt_1">
											<input type="text" name="workStartDt"
												maxlength="5" id="workStartDt_1" class="redaTxt dateMask hasDatepicker" value="<%= b.getEnterDate()%>">
										...
										<td class="calendar"><input type="text" name="workEndDt" maxlength="5" id="workEndDt_1"
												class="redaTxt dateMask hasDatepicker" value="<%= b.getResignDate()%>">
											<button type="button" class="ui-datepicker-trigger">
						...
						<script>
							$(".fieldSel<%= num %>").val("<%= b.getCareerType() %>").prop("selected", true);
							</script>  
						<% num = num+1;
						} %>
					</form>
