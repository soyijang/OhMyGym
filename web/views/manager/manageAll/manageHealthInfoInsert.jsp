...
<body>
	...
	<form action="<%=request.getContextPath()%>/healthInfoInsert.no" method="post">
	<table>
	<tr>
		<td width="300px" height="50px" style="text-align: left; background:#e3e3e3;"><a id="text">카테고리</a></td>
		<td width="850px" height="50px"><legend align="left">
			...
			<input type="radio" name="category" value="이용약관변경"><label>식단정보</label>&nbsp;&nbsp;
			<input type="radio" name="category" value="기능안내"><label>운동정보</label>&nbsp;&nbsp;
			<input type="radio" name="category" value="버그수정안내"><label>건강정보</label>&nbsp;&nbsp;
