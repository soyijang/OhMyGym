 ...
 */
@WebServlet("/select.salary.all")
public class SelectManagerSalaryServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectManagerSalaryServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Salary> list = new SalaryService().selectListAll();
		System.out.println("list : " + list );
		
		String page= "";
		if(list != null) {
			page = "views/manager/manageTrainer/manageSalary.jsp";
