...
<body>
	...
	<tr>
		...
		<td width="850px" height="50px"><legend align="left"><%=healthInfo.getBoardCategory() %></legend></td>
	</tr>
	<tr>
		<td width="300px" height="80px" style="text-align: left; background:#e3e3e3;"><a id="text">게시일</a></td>
		<td width="850px" height="80px"><legend align="left"><%=healthInfo.getWritedate() %></legend></td>
	</tr>
	<tr>
		<td width="300px" height="50px" style="text-align: left; background:#e3e3e3;"><a id="text">공개상태</a></td>
		<td width="850px" height="50px"><legend align="left"><%=healthInfo.getStatus() %></legend></td>
	</tr>
	...
	<tr>
		...
		<textarea rows="20px" cols="120px" style="resize: none;" readonly="readonly"><%=healthInfo.getBoardContent()%>
	...
	<div style="text-align: right;">
		...
		<button id="btn1" onclick="location.href='<%=request.getContextPath()%>/healthInfoUpdate.no?num=<%=healthInfo.getBoardNum()%>'">수정</button>
		<%-- <%} %> --%>
	</div>
